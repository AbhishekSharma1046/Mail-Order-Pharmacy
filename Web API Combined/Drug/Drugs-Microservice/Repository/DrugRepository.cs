...
namespace MfpeDrugsApi.Repository
{
    public class DrugRepository : IRepository
    {
        ...
        {
          new Drug { Id = 1, Name = "Disprin", ManufacturedDate = Convert.ToDateTime("2020-5-6 12:12:00.0000000"), ExpiryDate = Convert.ToDateTime("2025-5-6 12:12:00.0000000"), Manufacturer = "Abbot"},
          new Drug { Id = 2, Name = "Paracetamol", ManufacturedDate = Convert.ToDateTime("2019-10-2 12:12:00.0000000"), ExpiryDate = Convert.ToDateTime("2025-9-2 12:12:00.0000000"), Manufacturer = "Intas"}
        };
        ...
        public List<DrugLocation> show()
        {
            return druglocationlist;
        }
    }
}
