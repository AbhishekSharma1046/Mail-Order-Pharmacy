...
namespace AuthorizationMicroService.Controllers
{
    ...
    public class TokenController : ControllerBase
    {
        ...
        private ITokenProvider<MemberDetails> @object;
        private readonly AuContext _Db;

        public TokenController(ITokenProvider<MemberDetails> _tokenProvider, AuContext Db)
        {
            _Db = Db;
            tokenProvider = _tokenProvider; 
        }

        public TokenController(ITokenProvider<MemberDetails> @object)
        {
            this.@object = @object;
        }
